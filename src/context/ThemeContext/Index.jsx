...
export const ThemeProvider = ({ children }) => {
  ...
  const bgColor = darkMode ? 'bg-grey-900 duration-500' : 'bg-grey-400 duration-500';
  const secondBgColor = darkMode ? 'bg-grey-200 duration-500' : 'bg-grey-600 duration-500';
